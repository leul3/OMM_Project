...
router.get('/:imageName', function(req, res, next) {
    ...
    // example of URL:
    // http://localhost:5555/memes/doge?text=Such+a+beautiful+code&bold=&size=50&font=Menlo&color=white&x=0&y=0&text2=Wow&bold2=bold&size2=50&font2=Menlo&color2=black&x2=0&y2=0
